...
<header class="bg-white shadow-md sticky top-0 z-50">
  <div class="max-w-6xl mx-auto px-4">
    <div class="flex justify-between items-center py-2">
      <!-- Logo -->
      <a href="/" class="shrink-0 transition-all transform hover:scale-105 active:scale-95">
        <img class="h-10 w-auto" src="/black_icon_transparent_background.png" alt="Stonewall Mind Academy Logo">
      </a>
